...
void MotionControlNode::init_params()
{
	...
	this->declare_parameter<float>("abort_grace_time", 3.0);
	...
	params.abort_grace_time = this->get_parameter("abort_grace_time").get_value<float>();
	...
	params.undock_collision_check_front_only = this->get_parameter("undock_collision_check_front_only").get_value<bool>();
